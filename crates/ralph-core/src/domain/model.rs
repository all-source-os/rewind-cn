...
impl TaskAggregate {
    pub fn apply_event(&mut self, event: &RalphEvent) {
        match event {
            ...
            RalphEvent::TaskAssigned { agent_id, .. } => {
...
mod tests {
    ...
    fn backlog_projection_tracks_tasks() {
        ...
        proj.apply_event(&RalphEvent::TaskCreated {
            task_id: TaskId::new("t-1"),
            title: "Task 1".into(),
        ...
        proj.apply_event(&RalphEvent::TaskCompleted {
            task_id: TaskId::new("t-1"),
            completed_at: Utc::now(),
        });
    ...
    fn epic_progress_tracks_tasks() {
        ...
        proj.apply_event(&RalphEvent::EpicCreated {
            epic_id: EpicId::new("e-1"),
            title: "Sprint 1".into(),
            description: "First sprint".into(),
            created_at: Utc::now(),
