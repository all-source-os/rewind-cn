...
const DEFAULT_TEMPLATE: &str = include_str!("templates/default_prompt.tera");
...
mod tests {
    ...
    #[test]
    fn render_default_template_when_path_missing() {
        let ctx = HashMap::from([
            ("task_description".into(), "Implement feature X".into()),
            ("repo_path".into(), "/tmp/repo".into()),
        ]);
